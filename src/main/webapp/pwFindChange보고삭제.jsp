...
<form name="pwChangeForm" id="pwChangeForm"> 
			<table class="login" style="float:left;">
				...
				<tr><td align="center" style="font-weight: bold;font-size: 19px; padding-bottom: 29px;">비밀번호 찾기</td></tr>
				...
				<tr style="height:25px;">	
					<td style="text-align: center; padding-top: 16px;  padding-bottom: 20px;">
				...
				<tr>
					<td class="auth_num" align="center" style="padding-right: 122px; padding-bottom: 37px;">
					<span class="nextId">
